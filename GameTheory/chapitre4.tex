...
$$-1 + \frac{1}{2\sqrt{na}} = 0 \iff na = \frac{1}{4} \iff a = \frac{1}{4n^2}$$
...
2. Définissons la fonction $\phi : X \to \mathcal{P}(X)$ par $\phi(x) = BR(x, x, \dots, x)$ ? Non, attention aux arguments.
