...
\begin{enumerate}
    \item \textbf{Coordination Game :} Exemple de la conduite (choix du côté de la route).
    \begin{center}
    \begin{tabular}{c|c|c}
    ...
    \item \textbf{Chicken Game (Hawk-Dove) :} Exemple d'une course aux brevets.
    \begin{center}
    \begin{tabular}{c|c|c}
    P1 \textbackslash P2 & a & b \\ \hline
    A & (0,0) & (4,1) \\ \hline
    ...
    \item \textbf{Matching Penny :} Modèle classique pour les \textbf{penalties au football} (Tireur vs Gardien).
    \begin{center}
    \begin{tabular}{c|c|c}
    P1 \textbackslash P2 & a & b \\ \hline
    A & (1,-1) & (-1,1) \\ \hline
    ...
    \item \textbf{Prisoner Dilemma :} Confesser (C) ou Non Confesser (NC).
    \begin{center}
    \begin{tabular}{c|c|c}
...
Chaque enchérisseur paie son offre, même s'il perd (modèle de lobbying ou de pots-de-vin).
\end{exemple}
