...
%--------------------------------------------------
\section{Stratégies d\'Arbitrage et Pratique du Marché}

\subsection{Genèse : L'arbitrage sur obligations convertibles}
%--------------------------------------------------
...
%--------------------------------------------------
\subsection{La stratégie CDS-Actions}
%--------------------------------------------------
...
\subsubsection{Le rôle du Chapter 11 américain}
...
%--------------------------------------------------
\subsection{La Convexité : le Graal de l'arbitriste}
%--------------------------------------------------
...
\subsubsection{Représentation graphique de la convexité}
...
\subsubsection{Cas limite : la fraude Enron}
...
%--------------------------------------------------
\subsection{Portage et Roll-down : le coût du temps}
%--------------------------------------------------

\subsubsection{Le portage (\textit{Carry})}
...
\subsubsection{La DV01 : unité de risque en crédit}
...
%--------------------------------------------------
\subsection{Les limites de l'IA face à la \textit{Small Data}}
%--------------------------------------------------

\subsubsection{Le problème de la non-stationnarité}
...
\subsubsection{Le mythe du Big Data en crédit}
...
%--------------------------------------------------
\section{L\'Approche Structurelle : Du Modèle de Merton à ses Extensions}

\subsection{Le Modèle de Merton Revisité : la Dette comme Option}
%--------------------------------------------------

\subsubsection{Structure de bilan et équilibre de marché}
...
\subsubsection{Représentation optionnelle}
...
\subsubsection{Déduction de la volatilité des actifs}
...
\subsubsection{Lien avec le spread de crédit et la convexité}
...
%--------------------------------------------------
\section{Dynamique et Modélisation de la Courbe de Crédit}

\subsection{La Courbe de Crédit et le Trade « Steepener »}
%--------------------------------------------------

\subsubsection{Problème d'extension : de la maturité unique à la courbe}
...
\subsubsection{La découverte du steepener (2003-2004)}
...
\subsubsection{Construction DV01-neutre et P\&L du Steepener}
...
%--------------------------------------------------
\subsection{Modélisation de la Courbe de Crédit : Deux Philosophies}
%--------------------------------------------------
...
\subsubsection{Le point de vue « à l'ancienne » : le taux court (Vasicek)}
...
\subsubsection{Le point de vue moderne : l'objet courbe (HJM)}
...
%--------------------------------------------------
\subsection{Vers un Modèle Cohérent : le Seuil de Défaut (Barrière)}
%--------------------------------------------------

\subsubsection{Problème des forwards négatifs dans Merton naïf}
...
\subsubsection{Le modèle à barrière : première formulation cohérente}
...
\subsubsection{Avantage et limite du modèle à barrière}
...
%--------------------------------------------------
\subsection{Formes de la Courbe de Crédit : Pathologies et Solutions}
%--------------------------------------------------

\subsubsection{Courbe en « chapeau de Napoléon » (dette constante)}
...
\subsubsection{Ajout d'un saut : résoudre le spread nul à court terme}
...
\subsubsection{CreditGrades et processus de Lévy}
...
%--------------------------------------------------
\section{Les Modèles à Forme Réduite (Intensité de Défaut)}

\subsection{Le Modèle d'Intensité de Duffie : une Alternative Pragmatique}
%--------------------------------------------------

\subsubsection{L'idée fondamentale : paramétrer l'intensité directement}
...
%--------------------------------------------------
\subsection{Applications : Trades LBO et Structures de Courbe}
%--------------------------------------------------

\subsubsection{Le trade LBO (\textit{Leveraged Buy-Out})}
...
\subsubsection{Inversion de courbe en cas de défaut imminent}
...
%--------------------------------------------------
\subsection{Pricing par EDP dans le Modèle d'Intensité (Processus de Cox)}
%--------------------------------------------------
...
\subsubsection{Pricing du CDS : décomposition en deux branches}
...
\subsubsection{Pricing des options : EDP de Black-Scholes généralisée}
