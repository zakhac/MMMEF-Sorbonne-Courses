...
\begin{checkpoint}
\begin{itemize}
    \item \textbf{Différences finies :} Quel est le compromis à trouver pour le choix du pas $\epsilon$ (Erreur de troncature vs Bruit) ?
    \item \textbf{Nelder-Mead :} Citez les trois opérations géométriques principales sur le simplexe (Réflexion, Expansion, Contraction).
    \item \textbf{Pattern Search :} Quelle condition sur les directions garantit la convergence ?
\end{itemize}
\end{checkpoint}
