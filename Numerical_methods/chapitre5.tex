...
\]
\textbf{Interprétation :} Cela signifie que $B_k$ approche suffisamment bien la Hessienne le long de la direction $p_k$. Il suffit que l'approximation soit suffisamment bonne dans cette direction, pas la peine qu'elle le soit dans tout l'espace.
