...
\begin{checkpoint}
\begin{itemize}
    \item \textbf{Newton Inexact :} Quel est le critère d'arrêt pour la résolution du système linéaire ?
    \item \textbf{Newton-CG :} Pourquoi cette méthode est-elle adaptée aux grandes dimensions (Produits matrice-vecteur uniquement) ?
    \item \textbf{Condition de courbure négative :} Que fait Newton-CG si $p^T \nabla^2 f p < 0$ ?
\end{itemize}
\end{checkpoint}
